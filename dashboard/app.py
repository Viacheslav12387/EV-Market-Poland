...
_layout = dict(
    ...
    title=dict(font=dict(color="#ffffff", size=13), x=0.02),
...
with tab1:
    ...
    fig_cmp = px.line(comparison, x="year", y="value", color="region", markers=True,
...
with tab2:
    ...
    fig_hist = px.line(sales_data, x="year", y="value", color="powertrain", markers=True,
    ...
    with col_a:
        ...
        fig_recent.update_layout(**_layout, barmode="group", showlegend=True)
    ...
    fig_stock = px.area(stock_data, x="year", y="value", color="powertrain",
...
with tab3:
    ...
    with col_c1:
        ...
        fig_ch.update_layout(**_layout, showlegend=False)
    ...
    with col_c2:
        ...
        fig_pie.update_layout(**_layout, showlegend=True)
...
with tab4:
    ...
    fig_fc = px.line(forecast_df, x="Rok", y="Sprzedaż", color="Scenariusz", markers=True,
    ...
    fig_infra.update_layout(**_layout, showlegend=False)
